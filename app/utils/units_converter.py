...
class UnitsConverter:
    ...
    VOLUME_CONVERSIONS = {
        ...
        'cubic_meters': 1.0  # Добавлен синоним
    }
    ...
    @classmethod
    def validate_volume_unit(cls, unit: str) -> bool:
        """Проверить поддерживается ли единица объема"""
        return unit in cls.VOLUME_CONVERSIONS
    
    @classmethod  
    def validate_mass_unit(cls, unit: str) -> bool:
        """Проверить поддерживается ли единица массы"""
        return unit in cls.MASS_CONVERSIONS